...
dir_profile_pattern: str = r'Y:\python\import_neuralynxv2\data\pinp8 06022020\profile_pattern'
...
reward = EventRewardNeuralynx(dir_profile_pattern=dir_profile_pattern, name_profile='synchro_video_classic')
...
dir_data = r'Y:\python\import_neuralynxv2\data\pinp8 06022020'
